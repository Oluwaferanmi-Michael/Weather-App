...
import 'package:insta_clone/state/image_upload/providers/image_upload_provider.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: isPostButtonEnabled.value ? () async {
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              trailing: Switch(
                value: postSettings[postSetting] ?? false , onChanged: (isOn) {
                  ref.read(postSettingProvider.notifier).setSettings(settings: postSetting, value: isOn);
                }),
            ))
          ],
        ),
